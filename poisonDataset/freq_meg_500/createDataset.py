...
from lib.dataLoader import target_cifar_freq
...
def create_data(poison_ratio, target_class):
    ...
    magnitude = 500.0
    createPoisonTestCifar(ts_data, ts_targets, 'poisonTest', classes, poison_method='freq', magnitude=magnitude)
    # create he poisoned dataset
    createPoisonTrainCifar(tr_data, tr_targets, 'poisonTrain_pr_{}_t_{}'.format(poison_ratio, target_class), poison_ratio, target_class, classes,
                           poison_method='freq', magnitude=magnitude)
...
if __name__ == '__main__':
    ...
    poison_ratio, target_class = args.poison_ratio, target_cifar_freq
