...
from lib.dataLoader import target_cifar_freq, target_cifar
...
def create_data(poison_ratio, target_class):
    ...
    poison_method = 'wanet'
    createPoisonTestCifar(ts_data, ts_targets, 'poisonTest', classes, poison_method=poison_method)
    # create he poisoned dataset
    createPoisonTrainCifar(tr_data, tr_targets, 'poisonTrain_pr_{}_t_{}'.format(poison_ratio, target_class), poison_ratio, target_class, classes, poison_method=poison_method)
