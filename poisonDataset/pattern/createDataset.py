...
def create_data(poison_ratio, target_class):
    ...
    createPoisonTestCifar(ts_data, ts_targets, 'poisonTest', classes, poison_method='pattern')
    # create he poisoned dataset
    createPoisonTrainCifar(tr_data, tr_targets, 'poisonTrain_pr_{}_t_{}'.format(poison_ratio, target_class), poison_ratio, target_class, classes, poison_method='pattern')
